...
| **Career tools** | Tailored CV, bullets, cover letter, learning plan, application pack |
...
2. Paste a job description (or HTTPS URL) on **Analyze**  
3. The eve agent parses, scores, and saves  
4. Open the report from **History**; the role also lands in **Tracker**  
5. Optionally tailor bullets, draft a cover letter, or re-score after edits  
